...
//this class implements the XOR operator
class Xor : public Binary { // the Binary is used as a subclass here
 public:
  // only accessors and mutators are public in this example
  Xor();
  Xor(int input1, int input2, std::bitset<32> bin_input1, std::bitset<32> bin_input2, std::bitset<32> Xoroutput);
