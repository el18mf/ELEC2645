...
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE                                 1024                                                                                             // set by library:rtos
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE_DEBUG_EXTRA                     256                                                                                              // set by library:rtos[STM]
...
#define MBED_CONF_RTOS_TIMER_THREAD_STACK_SIZE                                1536                                                                                             // set by library:rtos
