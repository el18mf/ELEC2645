...
const unsigned char font5x7[480] = {
    ...
    0x0E, 0x0A, 0x0E, 0x00, 0x00,// orignally ^ = 0x04, 0x02, 0x01, 0x02, 0x04 but changed to °
    0x40, 0x40, 0x40, 0x40, 0x40,// _
    0x00, 0x01, 0x02, 0x04, 0x00,// `
    0x20, 0x54, 0x54, 0x54, 0x78,// a
    0x7F, 0x48, 0x44, 0x44, 0x38,// b 0x7F, 0x48, 0x44, 0x44, 0x38, changed to stop issues with top pixel almost consistently carrying over to the bottom right of the line to the right of where it was supposed to be
    ...
    0x00, 0x48, 0x7A, 0x40, 0x00,// i 0x00, 0x44, 0x7D, 0x40, 0x00, changed to stop issues with top pixel almost consistently carrying over to the bottom right of the line to the right of where it was supposed to be
    0x20, 0x40, 0x44, 0x3D, 0x00,// j
    0x00, 0x7E, 0x10, 0x28, 0x44,// k 0x00, 0x7F, 0x10, 0x28, 0x44, changed to stop issues with top pixel almost consistently carrying over to the bottom right of the line to the right of where it was supposed to be
    0x00, 0x42, 0x7E, 0x40, 0x00,// l normal = 0x00, 0x41, 0x7F, 0x40, 0x00, changed to stop issues with top pixel almost consistently carrying over to the bottom right of the line to the right of where it was supposed to be
    ...
    0x04, 0x3E, 0x44, 0x40, 0x20,// t normal = 0x04, 0x3F, 0x44, 0x40, 0x20, changed to stop issues with top pixel almost consistently carrying over to the bottom right of the line to the right of where it was supposed to be
